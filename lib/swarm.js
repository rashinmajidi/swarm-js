...
module.exports = function (_ref) {
    ...
    var updateMutableResource = function updateMutableResource(swarmUrl) {
        return function (payLoad, MRU_MANIFEST_KEY) {
            ...
            var meta = response.then(function (metaStr) {
    ...
    var signature = function signature(period, version, rootAddr, metaHash, multihash, data) {
        web3_utils.soliditySha3({ t: 'uint64', v: period }, { t: 'uint64', v: version }, { t: 'bytes32', v: rootAddr }, { t: metaHash, v: metaHash }, { t: 'bool', v: multihash }, { t: 'bytes', v: data + "" });
    };
