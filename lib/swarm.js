...
module.exports = function (_ref) {
    ...
    var updateMutableResource = function updateMutableResource(swarmUrl) {
        return function (payLoad, MRU_MANIFEST_KEY) {
            ...
            response.then(function (metaStr) {
                ...
                var signature = getSignature(meta.period, meta.version, meta.rootAddr, meta.metaHash, payLoad.multihash, payLoad.data);
    ...
    var getSignature = function getSignature(period, version, rootAddr, metaHash, multihash, data) {
        return web3_utils.soliditySha3({ t: 'uint64', v: period }, { t: 'uint64', v: version }, { t: 'bytes32', v: rootAddr }, { t: 'bytes32', v: metaHash }, { t: 'uint8', v: multihash ? 1 : 0 }, { t: 'bytes', v: data });
    };
