    ...
    var updateMutableResource = function updateMutableResource(swarmUrl) {
        return function (payLoad, MRU_MANIFEST_KEY) {
            ...
            response.then(function (metaStr) {
                ...
                var dataToSign = getSha3(meta.period, meta.version, meta.rootAddr, meta.metaHash, payLoad.multihash, payLoad.data);
                ...
                web3.eth.sign(dataToSign, meta.ownerAddr).then(function (signature) {
                    ...
                    var recoveredAccount = account.recover(dataToSign, signature);
