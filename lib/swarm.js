    ...
    var updateMutableResource = function updateMutableResource(swarmUrl) {
        return function (payLoad, MRU_MANIFEST_KEY) {
            ...
            response.then(function (metaStr) {
                ...
                if (payLoad.period === 'undefined') payLoad.period = meta.period;
                if (payLoad.version === 'undefined') payLoad.version = meta.version;
                if (payLoad.metaHash === 'undefined') payLoad.metaHash = meta.metaHash;
                if (payLoad.rootAddr === 'undefined') payLoad.rootAddr = meta.rootAddr;
                if (payLoad.multiHash === 'undefined') payLoad.rootAddr = meta.multiHash;
